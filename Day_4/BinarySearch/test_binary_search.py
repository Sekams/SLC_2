...
class TestListComprehension(unittest.TestCase):
    ...
    # Testing if the class creates an array from 1 to 20, with intervals of 1
    ...
    # Testing if the class creates an array from 2 to 40, with intervals of 2
...
class TestBinarySearch(unittest.TestCase):
    """
        Test cases for finding if the search function gets the index of the item
        with an expected number of loops in an array and returns a dictionary
        containing {count: value, index: value}
    """
